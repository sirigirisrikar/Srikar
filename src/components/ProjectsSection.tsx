...
const ProjectsSection = () => {
  const projects = [
    {
      title: "Agrosmart:Farming Solution",
    ...
    {
      title: "Displaying Temperture and Humidity using Blynk IoT",
      description: "Displaying Temperture and Humidity using Blynk IoT.",
      image: project2,
