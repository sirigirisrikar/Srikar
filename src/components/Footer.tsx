      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold gradient-text">Srikar Reddy</h3>
            <p className="text-muted-foreground leading-relaxed">
              Final year ECE student passionate about creating innovative solutions 
        ...
        <div className="border-t border-primary/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              © 2024 Srikar Reddy. All rights reserved.
            </p>
